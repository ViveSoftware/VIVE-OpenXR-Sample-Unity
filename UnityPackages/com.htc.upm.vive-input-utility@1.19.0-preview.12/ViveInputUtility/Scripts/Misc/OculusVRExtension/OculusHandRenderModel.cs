    ...
    public class OculusHandRenderModel : MonoBehaviour
    {
        ...
        public void Initialize(bool isLeftHand)
        {
            ...
            try
            {
                ...
                FieldInfo dataProviderField = m_ovrSkeleton.GetType().GetField("_dataProvider", BindingFlags.NonPublic | BindingFlags.Instance);

                MethodInfo searchDataProviderMethod = m_ovrSkeleton.GetType().GetMethod("SearchSkeletonDataProvider", BindingFlags.NonPublic | BindingFlags.Instance);
