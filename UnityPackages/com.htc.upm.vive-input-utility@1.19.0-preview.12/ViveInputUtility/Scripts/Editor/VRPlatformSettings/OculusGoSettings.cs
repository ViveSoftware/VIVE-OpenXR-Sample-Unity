...
#endif
        {
            ...
            private string defaultAndroidManifestPath
            {
                get
                {
                    ...
                    if (fullPath.IndexOf("Assets") < 0) return fullPath.Substring(fullPath.IndexOf("Packages"), fullPath.Length - fullPath.IndexOf("Packages"));
                    else return fullPath.Substring(fullPath.IndexOf("Assets"), fullPath.Length - fullPath.IndexOf("Assets"));
#else
                    return string.Empty;
#endif
                }
