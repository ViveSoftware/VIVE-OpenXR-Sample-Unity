...
public class PortalBallBehaviour : MonoBehaviour
{
    ...
    IEnumerator SpwanPortalOnWall(float delay, Vector3 firstHitPos, Vector3 firstHitNormal)
    {
        ...
        {
            Debug.LogError("[PortalBallBehaviour][SpwanPortalOnCorner] EnvironmentManager.Instance is null. Cannot trigger OnPortalOpen.");
        }
    ...
    IEnumerator DestroyingPortal()
    {
        ...
        {
            Debug.LogError("[PortalBallBehaviour][DestroyingPortal] PortalSceneManager.Instance is null. Cannot set next portal.");
        }
